...
## Download
### <a href="https://github.com/1x09lol/JonarchyMod/releases">Download the latest release

1. Download the .jar matching your Minecraft version from the GitHub Releases page.
3. Install [Fabric Loader](https://fabricmc.net/).
4. Install [Fabric API](https://modrinth.com/mod/fabric-api).
5. Move the downloaded serverunblocker-mc-<version>.jar into your .minecraft/mods directory.
6. Start Minecraft using your Fabric installation.
